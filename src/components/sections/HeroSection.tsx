...
export function HeroSection() {
  return (
    <section
      className="relative w-full overflow-hidden bg-[#040814] min-h-[75vh] md:min-h-screen"
    >
      <HeroCarousel />
      ...
      <div
        ...
        style={{ maxWidth: 1440, margin: "0 auto", left: 0, right: 0, paddingTop: "clamp(60px, 10vmax, max(80px, 14vh))" }}
      >
        <div style={{ maxWidth: 600 }}>
          ...
          >
            {/* On mobile: three lines. On sm+: stays on two natural lines */}
